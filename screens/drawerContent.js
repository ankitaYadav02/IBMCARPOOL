        ...
        <View style={styles.drawerContent}>
          ...
          <Drawer.Section style={styles.drawerSection}>
            ...
            <DrawerItem
              label="Guidelines"
              onPress={() => {
                props.navigation.navigate('Guidelines');
              }}
            />
            <DrawerItem
              label="Your Health QR code"
              onPress={() => {
                props.navigation.navigate('Your Health QR code');
              }}
            />
            <DrawerItem
              label="Scan Health Qr"
              onPress={() => {
                props.navigation.navigate('Scan Health Qr');
              }}
            />
            <DrawerItem
              label="Parking"
              onPress={() => {
                props.navigation.navigate('Parking');
              }}
            />
          </Drawer.Section>
        </View>
